...
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| WW Normaltemp. Hyst.                    | ``SP,NR=84``    | ``r-``  | ``INT``     |  1             |  10            |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| WW Minimaltemp.                         | ``SP,NR=85``    | ``r-``  | ``INT``     |  5             |  45            |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| WW Minimaltemp. Hyst.                   | ``SP,NR=86``    | ``r-``  | ``INT``     |  1             |  10            |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| BSZ Heizkreispumpe Betriebsstunden      | ``SP,NR=153``   | ``r-``  | ``INT``     |  0             |  100000        |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| BSZ Heizkreispumpe Schaltzyklen         | ``SP,NR=155``   | ``r-``  | ``INT``     |  0             |  100000        |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| BSZ EQ Pumpe Betriebsstunden            | ``SP,NR=162``   | ``r-``  | ``INT``     |  0             |  100000        |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| BSZ EQ Pumpe Schaltzyklen               | ``SP,NR=164``   | ``r-``  | ``INT``     |  0             |  100000        |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| BSZ Frischwasserpumpe Betriebsstunden   | ``SP,NR=165``   | ``r-``  | ``INT``     |  0             |  100000        |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| BSZ Frischwasserpumpe Schaltzyklen      | ``SP,NR=167``   | ``r-``  | ``INT``     |  0             |  100000        |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| BSZ Zirkulationspumpe Betriebsstunden   | ``SP,NR=168``   | ``r-``  | ``INT``     |  0             |  100000        |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
| BSZ Zirkulationspumpe Schaltzyklen      | ``SP,NR=170``   | ``r-``  | ``INT``     |  0             |  100000        |
+-----------------------------------------+-----------------+---------+-------------+----------------+----------------+
